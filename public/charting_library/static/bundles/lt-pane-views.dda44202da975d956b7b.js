webpackJsonp([1], {
          ...
          2 === this._source.points().length
            ? ((e = this._source.priceScale()),
              ...
              (g = {
                0: function (e) {
                  return {
                    high: l(e[TradingChart.HIGH_PLOT]),
                    low: l(e[TradingChart.LOW_PLOT]),
                  };
                },
                1: function (e, t) {
                  return new r(u + t * f, l(e[TradingChart.CLOSE_PLOT]) + _.y);
                },
                2: function (e) {
                  return {
                    open: l(e[TradingChart.OPEN_PLOT]),
                    close: l(e[TradingChart.CLOSE_PLOT]),
                  };
                },
                3: function (e, t) {
                  return new r(u + t * f, l(e[TradingChart.OPEN_PLOT]) + _.y);
                },
                4: function (e, t) {
                  return new r(u + t * f, l(e[TradingChart.HIGH_PLOT]) + _.y);
                },
                5: function (e, t) {
                  return new r(u + t * f, l(e[TradingChart.LOW_PLOT]) + _.y);
                },
                6: function (e, t) {
                  return new r(
                    u + t * f,
                    l(
                      (e[TradingChart.HIGH_PLOT] + e[TradingChart.LOW_PLOT]) / 2
                    ) + _.y
                  );
                },
              }),
            ...
            ? ((n = this._adapter.getTooltip()),
              new l(l.CUSTOM, {
                mouseDownHandler: function () {
                  TradingChart.TradingWidget &&
                    TradingChart.TradingWidget.journalDialog();
                },
                tooltip:
                  "" !== n
              ...
              this._points.length >= 3 &&
                ...
                s.fillBackground.value() &&
                  ...
                  this._disjointAngleRenderer.setData({
                    ...
                    hittestOnBackground: TradingChart.isMobile.any(),
                  }),
          ...
          this._points.length < 2 || this._source.points().length < 2
            ...
            : ((t = this),
              ...
              (b = function (n, r, s, a, o, l, h) {
                if (t.isLabelVisible() || TradingChart.printing) {
                  var d = {};
                  (d.points = [r]),
                    (d.text = s),
    ...
    function r(e, t) {
      h.call(this, e, t),
        (this._clockWhite = _(
          ...
          TradingChart.wrapUrl("/static/images/prediction-clock-white.png")
        )),
        (this._clockBlack = _(
          "prediction-clock-black",
          TradingChart.wrapUrl("/static/images/prediction-clock-black.png")
        )),
        (this._successIcon = _(
          "prediction-success-white",
          TradingChart.wrapUrl("/static/images/prediction-success-white.png")
        )),
        (this._failureIcon = _(
          "prediction-failure-white",
          TradingChart.wrapUrl("/static/images/prediction-failure-white.png")
        )),
        ...
        h.prototype._updateImpl.call(this),
          ...
          this._source.points().length < 2 ||
            (this._source.priceScale() &&
              ...
              (o = t.time && e.time),
              o &&
                ((s = TradingChart.isString(t.time)
                  ? new Date(Date.parse(t.time))
                  : t.time),
                (a = TradingChart.isString(e.time)
  ...
  1173: function (e, t, i) {
    ...
    function r(e, t, i) {
      o.call(this, e, t),
        (this._image = c(
          "price_label",
          TradingChart.wrapUrl("/static/images/price_label.png")
        )),
        (this._rendererCache = {}),
        (this._invalidated = !0),
  ...
  1199: function (e, t, i) {
    ...
    inherit(n, s),
      (t.PaneRendererClockIcon = TradingChart.PaneRendererClockIcon = n);
  },
  1216: function (e, t, i) {
    "use strict";
    function n(e, t, i, n) {
